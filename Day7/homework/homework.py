...
#homeworkN1:1)scores=[20,43,56,73,10,6,87,45,97] სორტის გამოყენების გარეშე დააბრუნეთ ყველაზე დიდი რიცხვი.
...
#2)homeworkN2: students=["nika","ana","mamuka","iva","farna"] შეატრიალეთ უკუღმა sort  და reverse მეთოდის გარეშე.
